  ...
  return (
    <div data-navbar-wrapper="true">
      ...
      <motion.nav
        ...
        data-navbar="true"
        className="fixed top-0 left-0 z-50 w-full h-14 rounded-none px-4 md:px-5 lg:px-6 py-0 flex items-center justify-between gap-2 md:gap-3 lg:gap-4 bg-white dark:bg-black backdrop-blur-xl border-b border-slate-200/50 dark:border-white/10 shadow-sm"
      >
        {/* Left section - Logo */}
        <Link 
          href="/" 
        ...
        >
          ...
          <span className="font-semibold text-slate-900 dark:text-white text-xs sm:text-sm md:text-base lg:text-lg">
            ShiftPilot
          </span>
        </Link>
        ...
        <div className="flex items-center gap-2 md:gap-3 flex-shrink-0">
          ...
          >
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-lg text-sm text-slate-900 dark:text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
          ...
          <div className="p-2 rounded-md transition-all active:opacity-70 min-w-[44px] min-h-[44px] flex items-center justify-center touch-manipulation">
            <DarkModeToggle />
          </div>
          ...
          <Link
            href="/login"
            className="hidden md:block px-3 md:px-4 py-1.5 md:py-2.5 rounded-lg text-xs sm:text-sm font-medium transition-all bg-slate-900 dark:bg-white text-white dark:text-slate-900 active:bg-slate-800 dark:active:bg-white/90 min-h-[36px] sm:min-h-[44px] flex items-center touch-manipulation"
