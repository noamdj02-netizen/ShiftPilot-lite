...
-- Version: 1.0 Production Ready (FIXED)
-- Migration: 026
-- Date: 2024
-- =============================================
-- 
...
--
-- IMPORTANT: Ce script vérifie l'existence des tables avant de créer
-- les politiques RLS pour éviter l'erreur "column does not exist"
--
-- =============================================
...
-- Activer RLS uniquement si les tables existent
DO $$
BEGIN
  ...
  IF EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'indisponibilites') THEN
  ...
  IF EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'historique_fatigue') THEN
...
-- Supprimer les politiques RLS existantes si elles existent (pour éviter les conflits)
DO $$
BEGIN
  IF EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'restaurants') THEN
...
-- Créer les politiques RLS (uniquement si les tables existent)
DO $$
BEGIN
  -- Policies pour restaurants
  IF EXISTS (SELECT FROM pg_tables WHERE schemaname = 'public' AND tablename = 'restaurants') THEN
    IF NOT EXISTS (SELECT FROM pg_policies WHERE schemaname = 'public' AND tablename = 'restaurants' AND policyname = 'Utilisateurs voient leurs restaurants') THEN
      CREATE POLICY "Utilisateurs voient leurs restaurants"
        ON restaurants FOR SELECT
        USING (owner_id = auth.uid());
    END IF;
    
    IF NOT EXISTS (SELECT FROM pg_policies WHERE schemaname = 'public' AND tablename = 'restaurants' AND policyname = 'Utilisateurs créent leurs restaurants') THEN
      CREATE POLICY "Utilisateurs créent leurs restaurants"
        ON restaurants FOR INSERT
        WITH CHECK (owner_id = auth.uid());
    END IF;
    
    IF NOT EXISTS (SELECT FROM pg_policies WHERE schemaname = 'public' AND tablename = 'restaurants' AND policyname = 'Utilisateurs modifient leurs restaurants') THEN
      CREATE POLICY "Utilisateurs modifient leurs restaurants"
        ON restaurants FOR UPDATE
        USING (owner_id = auth.uid());
    END IF;
    
    IF NOT EXISTS (SELECT FROM pg_policies WHERE schemaname = 'public' AND tablename = 'restaurants' AND policyname = 'Utilisateurs suppriment leurs restaurants') THEN
  ...
  IF EXISTS (
    ...
    IF NOT EXISTS (SELECT FROM pg_policies WHERE schemaname = 'public' AND tablename = 'employes' AND policyname = 'Accès employés via restaurant') THEN
  ...
  IF EXISTS (
    ...
    FROM information_schema.columns
    WHERE table_schema = 'public'
      AND table_name = 'indisponibilites'
      AND column_name = 'employe_id'
  ) THEN
    IF NOT EXISTS (SELECT FROM pg_policies WHERE schemaname = 'public' AND tablename = 'indisponibilites' AND policyname = 'Accès indisponibilités via employé') THEN
  ...
  IF EXISTS (
    ...
    FROM information_schema.columns
    WHERE table_schema = 'public'
      AND table_name = 'plannings'
      AND column_name = 'restaurant_id'
  ) THEN
    IF NOT EXISTS (SELECT FROM pg_policies WHERE schemaname = 'public' AND tablename = 'plannings' AND policyname = 'Accès plannings via restaurant') THEN
  ...
  IF EXISTS (
    ...
    IF NOT EXISTS (SELECT FROM pg_policies WHERE schemaname = 'public' AND tablename = 'shifts' AND policyname = 'Accès shifts via restaurant') THEN
  ...
  IF EXISTS (
    ...
    IF NOT EXISTS (SELECT FROM pg_policies WHERE schemaname = 'public' AND tablename = 'alertes' AND policyname = 'Accès alertes via restaurant') THEN
  ...
  IF EXISTS (
    ...
    FROM information_schema.columns
    WHERE table_schema = 'public'
      AND table_name = 'previsions_activite'
      AND column_name = 'restaurant_id'
  ) THEN
    IF NOT EXISTS (SELECT FROM pg_policies WHERE schemaname = 'public' AND tablename = 'previsions_activite' AND policyname = 'Accès prévisions via restaurant') THEN
  ...
  IF EXISTS (
    ...
    FROM information_schema.columns
    WHERE table_schema = 'public'
      AND table_name = 'historique_fatigue'
      AND column_name = 'employe_id'
  ) THEN
    IF NOT EXISTS (SELECT FROM pg_policies WHERE schemaname = 'public' AND tablename = 'historique_fatigue' AND policyname = 'Accès fatigue via employé') THEN
  ...
  IF EXISTS (
    ...
    FROM information_schema.columns
    WHERE table_schema = 'public'
      AND table_name = 'messages_planning'
      AND column_name = 'restaurant_id'
  ) THEN
    IF NOT EXISTS (SELECT FROM pg_policies WHERE schemaname = 'public' AND tablename = 'messages_planning' AND policyname = 'Accès messages via restaurant') THEN
  ...
  IF EXISTS (
    ...
    FROM information_schema.columns
    WHERE table_schema = 'public'
      AND table_name = 'contraintes_legales'
      AND column_name = 'restaurant_id'
  ) THEN
    IF NOT EXISTS (SELECT FROM pg_policies WHERE schemaname = 'public' AND tablename = 'contraintes_legales' AND policyname = 'Accès contraintes via restaurant') THEN
