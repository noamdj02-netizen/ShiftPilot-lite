    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="md:col-span-2 space-y-8">
            <div className="flex items-center gap-8">
              <div>
                ...
                <p className="text-sm text-foreground-muted">restaurants équipés</p>
              </div>
              <div>
                <p className="text-5xl font-bold text-foreground mb-2">4.9</p>
                <p className="text-sm text-foreground-muted">/5 satisfaction client</p>
              </div>
            </div>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border">
          <p className="text-sm text-foreground-muted text-center mb-6">Ils nous font confiance</p>
          <div className="flex flex-wrap items-center justify-center gap-8 opacity-60">
            {["Le Comptoir Parisien", "Brasserie du Port", "La Table d'Antoine", "Bistrot des Halles", "Casa Nostra"].map((name, i) => (
              <div
                key={i}
                className="text-foreground-muted text-sm font-medium hover:opacity-100 transition-opacity"
              >
                {name}
              </div>
            ))}
