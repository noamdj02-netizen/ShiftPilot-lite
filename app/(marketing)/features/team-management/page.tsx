      ...
      <section className="py-20 lg:py-32 bg-background relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg lg:text-xl text-foreground-secondary max-w-2xl mx-auto leading-relaxed font-light">
            Compétences, disponibilités, échanges de shifts. Tout pour une gestion d'équipe optimale.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                description: 'Définissez les compétences de chaque employé (serveur, barman, cuisinier) pour une attribution optimale.',
                color: 'accent',
              },
              {
                icon: Calendar,
                title: 'Disponibilités',
                description: 'Gérez les disponibilités de chaque employé. L\'IA en tient compte pour générer les plannings.',
                color: 'cyan',
              },
              {
                icon: RefreshCw,
                title: 'Échanges de shifts',
                description: 'Vos employés gèrent leurs échanges directement. Vous validez en un clic.',
                color: 'violet',
              },
            ].map((feature, i) => {
