...
--
-- Tables principales:
-- - restaurants: Informations du restaurant
-- - employes: Membres de l'équipe
-- - plannings: Planning hebdomadaire
-- - shifts: Créneaux de travail individuels
-- - alertes: Alertes et notifications système
-- - indisponibilites: Congés et absences
-- - contraintes_legales: Paramètres légaux HCR
-- - previsions_activite: Prévisions de charge
-- - historique_fatigue: Suivi de la fatigue
-- - messages_planning: Messages envoyés aux employés
--
-- =============================================
...
-- =============================================
-- Supprimer la table si elle existe déjà (pour migration propre)
-- ATTENTION: Cela supprimera toutes les données existantes
-- DROP TABLE IF EXISTS messages_planning CASCADE;
-- DROP TABLE IF EXISTS historique_fatigue CASCADE;
