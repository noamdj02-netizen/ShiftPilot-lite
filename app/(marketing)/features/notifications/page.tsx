    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="py-20 lg:py-32 bg-background relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border-violet/20 text-sm font-medium text-violet mb-6">
            <MessageSquare className="w-4 h-4" />
            Notifications
          </div>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-6 leading-tight tracking-tight">
            Votre équipe informée{' '}
          ...
          <p className="text-lg lg:text-xl text-foreground-secondary max-w-2xl mx-auto leading-relaxed font-light">
            SMS, WhatsApp, email. Envoyez les plannings et notifications instantanément à toute votre équipe.
          </p>
        </div>
      </section>
            ...
            {[
              {
                ...
                description: 'Envoyez les plannings directement par SMS ou WhatsApp. Vos employés reçoivent leurs shifts instantanément.',
                color: 'accent',
              },
              {
                icon: Mail,
                title: 'Notifications email',
                description: 'Rappels automatiques, changements de shifts, demandes d\'échange. Tout par email.',
                color: 'cyan',
              },
              {
                icon: Bell,
                title: 'Alertes en temps réel',
                description: 'Notifications push pour les changements urgents et les mises à jour importantes.',
                color: 'violet',
              },
            ].map((feature, i) => {
