      ...
      <section className="py-20 lg:py-32 bg-background relative overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-foreground mb-6 leading-tight tracking-tight">
            Besoin d'<span className="gradient-text">aide</span> ?
          </h1>
            ...
            {[
              {
                icon: Book,
                title: 'Documentation',
                description: 'Consultez notre documentation complète avec guides et tutoriels.',
                href: '/docs',
                color: 'accent',
              },
              {
                icon: MessageCircle,
                title: 'FAQ',
                description: 'Réponses aux questions les plus fréquentes sur ShiftPilot.',
                href: '#faq',
                color: 'cyan',
              },
              {
                ...
                description: 'Notre équipe est là pour vous aider. Contactez-nous par email.',
                href: '/contact',
                color: 'violet',
              },
            ].map((item, i) => {
              ...
              return (
                <a
                  key={i}
                  href={item.href}
                  className="glass rounded-2xl p-6 lg:p-8 border border-border hover:border-border-light transition-all duration-300 hover:shadow-lg block"
                >
